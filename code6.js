...
// # Пример: вызов функции sayHello('Антон') возвращает строку "Привет, Антон!". В решении вызывать функцию не нужно, программа сделает 
// это за вас.
...
function returnNeighboringNumbers(number){
    let data = [];
    data.push(number - 1, number, number + 1);
